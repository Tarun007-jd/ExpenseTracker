...
const Navbar = ({ onMenuClick }) => {
    ...
    return (
        <header className="sticky top-0 z-30 bg-white/80 dark:bg-dark-800/80 backdrop-blur-md border-b border-slate-200 dark:border-dark-700/50 shadow-sm">
            <div className="flex items-center justify-between h-[72px] px-6 lg:px-8 max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-3">
                    <button className="p-2.5 rounded-xl hover:bg-primary-50 transition-colors relative group">
                        <HiOutlineBell className="w-6 h-6 text-slate-900 dark:text-slate-400 group-hover:text-primary-600 transition-colors" />
