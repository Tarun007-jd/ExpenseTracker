...
const StatCard = ({ icon: Icon, label, value, trend, trendUp, color = 'primary' }) => {
    ...
    return (
        ...
        >
            ...
            <p className="text-3xl font-extrabold text-dark-900 dark:text-dark-100 tracking-tight">{value}</p>
            <p className="text-sm text-dark-900 dark:text-dark-400 mt-1 font-semibold uppercase tracking-wider">{label}</p>
        </motion.div>
    );
};
