        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md glass-card p-6 animate-scale-in">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    >
                        <HiOutlineX className="w-5 h-5 text-dark-900" />
                    </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    {/* Amount */}
                    <div>
                        <label className="block text-sm font-medium text-dark-900 dark:text-dark-400 mb-1.5">Amount (₹)</label>
                        <input
                            type="number"
                            step="0.01"
                            min="0"
                ...
                outline-none transition-all text-lg font-semibold"
                    ...
                    {/* Category */}
                    <div>
                        <label className="block text-sm font-medium text-dark-900 dark:text-dark-400 mb-1.5">Category</label>
                        <select
                ...
                outline-none transition-all"
                    ...
                    {/* Date */}
                    <div>
                        <label className="block text-sm font-medium text-dark-900 dark:text-dark-400 mb-1.5">Date</label>
                        <input
                            type="date"
                            required
                            value={formData.date}
                ...
                outline-none transition-all"
                    ...
                    {/* Description */}
                    <div>
                        <label className="block text-sm font-medium text-dark-900 dark:text-dark-400 mb-1.5">Description</label>
                        <textarea
